...
core/base_module.py
===================
Абстрактный базовый класс (контракт) для всех модулей SuperApp.
Реализует паттерны «Шаблонный метод» и «Плагин».
Ядро работает только через этот интерфейс — конкретных классов не знает.
"""
